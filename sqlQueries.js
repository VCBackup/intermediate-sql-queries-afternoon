...
SELECT * FROM Invoice i JOIN InvoiceLine il ON i.InvoiceId=il.InvoiceId WHERE il.UnitPrice > .99
* Get all invoices and show me their invoice date, customer first and last names, and total
SELECT i.InvoiceDate, c.FirstName, c.LastName, i.Total FROM Invoice i JOIN Customer c ON i.InvoiceId=c.CustomerId
...
SELECT plt.TrackId FROM PlaylistTrack plt JOIN Playlist pl ON plt.PlaylistId=pl.PlaylistId WHERE plt.PlaylistId = 1
